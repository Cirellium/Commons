...
import net.cirellium.commons.common.data.storage.implementation.sql.connection.old.AbstractDatabaseConnector;
import net.cirellium.commons.common.data.storage.implementation.sql.connection.old.DatabaseConnectorSQL;
import net.cirellium.commons.common.data.storage.implementation.sql.connection.old.DatabaseConnectorSQLite;
...
public abstract class DatabaseControllerService<P extends CirelliumPlugin<P>> extends AbstractService<P> {
    ...
    public DatabaseControllerService(P plugin, StorageType storageType) {
        ...
        //DatabaseFile file = (DatabaseFile) ((FileHandlerService) getService(ServiceType.FILE)).getFile("database");
        DatabaseFile databaseFile = getDatabaseFile();

        this.options = DatabaseOptions.from(databaseFile.get().getConfigurationSection("database"));

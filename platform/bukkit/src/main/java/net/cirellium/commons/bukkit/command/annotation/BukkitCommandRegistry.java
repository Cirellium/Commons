...
import net.cirellium.commons.common.command.adapter.implementation.BooleanTypeAdapter;
import net.cirellium.commons.common.command.adapter.implementation.DoubleTypeAdapter;
import net.cirellium.commons.common.command.adapter.implementation.FloatTypeAdapter;
import net.cirellium.commons.common.command.adapter.implementation.IntegerTypeAdapter;
import net.cirellium.commons.common.command.adapter.implementation.StringTypeAdapter;
import net.cirellium.commons.common.command.adapter.implementation.UUIDTypeAdapter;
